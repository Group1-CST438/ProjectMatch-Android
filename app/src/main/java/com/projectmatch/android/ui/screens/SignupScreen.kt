        ...
        Column(
            ...
            HexPanel(
                ...
                Column(
                    ...
                    Text(
                        text = "Join ProjectMatch",
                        fontSize = 20.sp,
                        fontWeight = FontWeight.SemiBold,
                        color = TextPrimary,
                    )
                    Text(
                        text = "Create an account to start finding collaborators and building real projects with classmates.",
                        fontSize = 13.sp,
                        color = TextMuted,
            ...
            Row(verticalAlignment = Alignment.CenterVertically) {
                Text("Already have an account? ", fontSize = 13.sp, color = TextSubtle)
                Text(
                    text = "Log in",
                    fontSize = 13.sp,
                    fontWeight = FontWeight.SemiBold,
                    color = ButtonAccent,
                    modifier = Modifier.noRippleClickable(onLogin),
                )
            }
        }
    }
